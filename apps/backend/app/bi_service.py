...
from app.bi_insights import CONVERT_BUCKETS, RFM_SEGMENTS, analysis, attention, customer_analytics, customer_profile, \
    orders, overview, key_customers_all_sources, product_margins, rfm_key_customers, workbench
...
__all__ = [
    ...
    'key_customers_all_sources', 'orders', 'overview', 'product_margins', 'rfm_key_customers', 'workbench',
