...
import { contactResultOptions as results, crmActivityLabels, decisionRoleOptions as decisionRoles, interactionMethodOptions as methods, opportunityStageOptions as stages } from "../../lib/labels";
...
export function DetailSections({ detail, customer, profile, role, userId, processWrite, customerWrite, busy, loading, name, detailTab, edit, setEdit, personOptions, selected, act, save, open, historyOffset, onHistoryOffset }: {
  detail: Detail;
  customer: Customer;
