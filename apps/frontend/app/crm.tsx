...
type Opportunity = { id: string; customer_id: string; opportunity_name: string; owner_user_id: string; stage: string; status: string; estimated_amount: string | null; probability: string | null; weighted_amount: string | null; expected_close_date: string | null; need_summary: string | null; lost_reason: string | null; closed_at: string | null; products: {id: string; name: string}[] };
...
export default function CRM({role, userId, entry, embedded=false}: {role: Role; userId: string; entry?: CRMEntry; embedded?:boolean}) {
  ...
  const contactFields: Field[]=[{key:"name",label:"联系人姓名",required:true,maxLength:100},{key:"role_label",label:"关系角色（如老板、采购）",maxLength:64},{key:"mobile",label:"联系电话",maxLength:32},{key:"wechat",label:"微信",maxLength:100},{key:"email",label:"邮箱",maxLength:255},{key:"decision_role",label:"决策角色",options:[["","未指定"],["decision_maker","关键决策人"],["buyer","采购"],["finance","财务"],["influencer","影响人"],["user","使用者"],["introducer","引荐人"],["other","其他"]]},{key:"is_primary",label:"主要联系人",type:"checkbox"},{key:"relationship_note",label:"关系备注",type:"textarea"},{key:"is_active",label:"联系人有效",type:"checkbox"}];
