...
export default function Home() {
  ...
  return <div className={`workspace dash-root${view === "home" && user.role_code === "owner" ? " cockpit-shell" : ""}${menuOpen ? " navigation-open" : ""}`}><aside>
    <div className="brand"><img src="/logo-mark.png" alt="好客齐鲁 logo" className="brand-mark small"/><div><strong>好客齐鲁</strong><small>经营管理平台</small></div><button className="mobile-menu" aria-label="展开主导航" aria-expanded={menuOpen} onClick={() => setMenuOpen(v => !v)}>菜单</button></div>
